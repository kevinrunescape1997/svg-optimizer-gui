...
Examples:
  ...
  python svg_exporter.py *.svg --format png --dpi 300
...
def which_ghostscript() -> Optional[str]:
    # Prefer gs on Unix, gswin64c/gswin32c on Windows
            ...
            with tempfile.TemporaryDirectory() as td:
                ...
                if ok_png:
                    ...
                    if ok_tif:
                        ...
                        # fallback to CairoSVG path below
                        pass
